...
public final class FirstPartTasks {
    ...
    public static List<Album> sortByAverageRating(Stream<Album> albums) {
        return albums.sorted(Collections.reverseOrder(Comparator.comparing(album -> album.getTracks()
                                                                .stream()
    ...
    public static String joinTo(String... strings) {
        return "<" + Arrays.stream(strings).collect(Collectors.joining(", ")).concat(">");
    }
